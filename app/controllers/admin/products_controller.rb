class Admin::ProductsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_product.save
        format.html { redirect_to admin_product_url(@admin_product), notice: "Товар успішно додано" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_products_url, notice: "Товар видалено успшіно" }
