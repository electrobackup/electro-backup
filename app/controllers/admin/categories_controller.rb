class Admin::CategoriesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_category.save
        format.html { redirect_to admin_category_url(@admin_category), notice: "Категорію успішно додано" }
  ...
  def update
    respond_to do |format|
      if @admin_category.update(admin_category_params)
        format.html { redirect_to admin_category_url(@admin_category), notice: "Категорію успішно оновлено" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_categories_url, notice: "Категорію успішно видалено" }
